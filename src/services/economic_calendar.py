...
class EconomicEvent:
    ...
    predicted_impact: Optional[str] = None  # Predicted market reaction
    actual_impact: Optional[str] = None     # Actual market reaction (filled after event)
    sentiment_score: Optional[float] = None  # -1 to 1 sentiment score
