...
from services.candlestick.exceptions import AllExchangesFailedError, CandlestickServiceError
...
async def fetch_candlesticks(
    ...
    Example:
        >>> from services.candlestick import fetch_candlesticks, CandleInterval
        >>>
