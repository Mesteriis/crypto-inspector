...
async def get_crypto_prices() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_crypto_prices as _get_crypto_prices
...
async def get_crypto_analysis(symbol: str) -> dict[str, Any]:
    ...
    from service.mcp.tools import get_crypto_analysis as _get_crypto_analysis
...
async def get_candlesticks(symbol: str, interval: str = "1h", limit: int = 100) -> dict[str, Any]:
    ...
    from service.mcp.tools import get_candlesticks as _get_candlesticks
...
async def get_market_summary() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_market_summary as _get_market_summary
...
async def get_fear_greed_index() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_fear_greed_index as _get_fear_greed_index
...
async def get_btc_dominance() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_btc_dominance as _get_btc_dominance
...
async def get_altseason_index() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_altseason_index as _get_altseason_index
...
async def get_traditional_finance() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_traditional_finance as _get_traditional_finance
...
async def get_whale_alerts() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_whale_alerts as _get_whale_alerts
...
async def get_exchange_flow() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_exchange_flow as _get_exchange_flow
...
async def get_funding_rates() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_funding_rates as _get_funding_rates
...
async def get_liquidation_levels(symbol: str = "BTC") -> dict[str, Any]:
    ...
    from service.mcp.tools import get_liquidation_levels as _get_liquidation_levels
...
async def get_correlations() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_correlations as _get_correlations
...
async def get_volatility() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_volatility as _get_volatility
...
async def get_macro_events() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_macro_events as _get_macro_events
...
async def get_token_unlocks() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_token_unlocks as _get_token_unlocks
...
async def get_investor_status() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_investor_status as _get_investor_status
...
async def get_dca_recommendation() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_dca_recommendation as _get_dca_recommendation
...
async def get_profit_taking_levels(symbol: str = "BTC") -> dict[str, Any]:
    ...
    from service.mcp.tools import get_profit_taking_levels as _get_profit_taking_levels
...
async def get_signals(hours: int = 24) -> dict[str, Any]:
    ...
    from service.mcp.tools import get_signals as _get_signals
...
async def get_bybit_portfolio() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_bybit_portfolio as _get_bybit_portfolio
...
async def get_backfill_status() -> dict[str, Any]:
    ...
    from service.mcp.tools import get_backfill_status as _get_backfill_status
