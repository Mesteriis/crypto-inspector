...
async def get_crypto_analysis(symbol: str) -> dict[str, Any]:
    ...
    Returns:
        ...
        - Composite score
    """
    from service.analysis import ScoringEngine
...
async def get_market_summary() -> dict[str, Any]:
    ...
    - Market phase
    """
    from service.analysis import OnChainAnalyzer
    from service.analysis.altseason import get_altseason_tracker
...
async def get_whale_alerts() -> dict[str, Any]:
    ...
    Returns:
        ...
        - Net flow direction
    """
    from service.analysis.whales import get_whale_monitor
...
async def get_exchange_flow() -> dict[str, Any]:
    ...
    Returns:
        ...
        - Historical trend
    """
    from service.analysis.exchange_flow import get_exchange_flow_tracker
...
async def get_funding_rates() -> dict[str, Any]:
    ...
    Returns:
        ...
        - Historical average
    """
    from service.analysis import DerivativesAnalyzer
...
async def get_liquidation_levels(symbol: str = "BTC") -> dict[str, Any]:
    ...
    Returns:
        ...
        - Risk assessment
    """
    from service.analysis.liquidations import get_liquidation_tracker
...
async def get_token_unlocks() -> dict[str, Any]:
    ...
    Returns:
        ...
        - Risk assessment
    """
    from service.analysis.unlocks import get_unlocks_tracker
...
async def get_investor_status() -> dict[str, Any]:
    ...
    Returns:
        ...
        - DCA recommendation
    """
    from service.analysis import get_investor_analyzer
