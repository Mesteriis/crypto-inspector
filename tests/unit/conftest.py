...
def mock_scoring_engine():
    ...
    with patch("service.analysis.scoring.ScoringEngine") as mock:
        ...
        score_result.to_dict = MagicMock(return_value={
...
def mock_investor_analyzer():
    ...
    with patch("service.analysis.investor") as mock:
        mock.get_investor_status = AsyncMock(return_value={
            "do_nothing_ok": True,
            "phase": "accumulation",
            "calm_indicator": 75,
            "red_flags": [],
...
def mock_chronos_forecaster():
    ...
    with patch("service.ml.chronos_forecaster.ChronosForecaster") as mock:
        instance = mock.return_value
        instance.forecast = AsyncMock(return_value={
...
def mock_optimizer():
    ...
    with patch("service.ml.optimizer.HyperparameterOptimizer") as mock:
        instance = mock.return_value
        instance.optimize = AsyncMock(return_value={
    ...
    def _create(
        ...
        **kwargs
        ...
        return {
            ...
            "symbol": symbol,
            "signal_type": kwargs.get("signal_type", faker.random_element(["rsi_oversold", "macd_bullish", "golden_cross"])),
