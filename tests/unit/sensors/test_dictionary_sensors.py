...
class TestDictionarySensorFormats:
    ...
    def test_ta_indicators_format(self, sample_crypto_data):
        ...
        ta_data = {"rsi": {}, "macd_signal": {}, "bb_position": {}, "trend": {}}
    ...
    def test_nested_dictionary_validation(self):
        ...
        complex_data = {
            "BTC": {
                ...
                "confidence": 85,
                "forecast_24h": 96000,
                "indicators": {"rsi": 65.5, "macd": "bullish", "support": 92000},
            },
            "ETH": {
                "trend": "Neutral",
                "confidence": 90,
                "forecast_24h": 3150,
                "indicators": {"rsi": 45.2, "macd": "neutral", "support": 3000},
            },
        }
...
class TestDictionarySensorUpdates:
    ...
    async def test_update_ai_trends_sensor(self):
        ...
        ai_trends = {"BTC": "Bullish", "ETH": "Neutral", "SOL": "Bullish"}
    ...
    async def test_update_exchange_flows_sensor(self):
        ...
        flows = {"BTC": -1250.5, "ETH": 680.2, "SOL": -295.8}
...
class TestDictionarySensorEdgeCases:
    ...
    def test_mixed_data_types(self):
        ...
        mixed_data = {
            "BTC": {"price": 95000.0, "change_pct": 2.5, "is_bullish": True, "signal_strength": "strong"},
            "ETH": {"price": 3200.0, "change_pct": -1.2, "is_bullish": False, "signal_strength": "weak"},
        }
