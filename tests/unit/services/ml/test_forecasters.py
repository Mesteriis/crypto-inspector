...
class TestChronosBoltForecaster:
    ...
    async def test_forecast_with_mock(self, sample_candles):
        ...
        try:
            from service.ml.chronos_forecaster import ChronosBoltForecaster, CHRONOS_AVAILABLE
...
class TestStatsForecastForecaster:
    ...
    async def test_forecast_arima(self, sample_candles):
        ...
        try:
            from service.ml.stats_forecaster import StatsForecastForecaster, STATSFORCEAST_AVAILABLE
